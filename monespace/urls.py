...
urlpatterns = [
    ...
    path('site/benevoles/<int:location_id>', views.users_site, name='users_site'),
    ...
    path('event/details/<int:event_id>', views_events.event_details, name='event_details'),
    path('event/modifier/<int:event_id>', views_events.event_edit, name='event_edit'),
    path('event/modifier/simple/<int:event_id>', views_events.event_edit_specific_rec, name='event_edit_specific_rec'),
    ...
    path('site/<int:location_id>', views_locations.location_details, name='location_details'),
    path('site/modifier/<int:location_id>', views_locations.location_edit, name='location_edit'),
